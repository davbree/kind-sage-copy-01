...
1. Get "stackbit-deploy (Read+Write)" API token from your [Sanity management console](https://manage.sanity.io/projects/w0gnibnj/settings/api)
...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/sanity-pull --ssg gatsby --sanity-project-id w0gnibnj --sanity-token $SANITY_ACCESS_TOKEN
...
To start editing your site, you can use the Sanity interface at https://kind-sage-cef51.sanity.studio/.
...
Generated at `2021-05-25T12:37:04.070Z` by Stackbit version `0.3.53-staging.1`.